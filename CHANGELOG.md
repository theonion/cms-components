...
## 0.4.0
PR https://github.com/theonion/cms-components/pull/6

Moves https://github.com/theonion/token-auth-frontend into this library and cleans up related components.
